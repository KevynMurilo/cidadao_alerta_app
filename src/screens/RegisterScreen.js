...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 32, fontWeight: 'bold', color: '#34495e' },
    subtitle: { fontSize: 16, color: '#7f8c8d', marginTop: 5 },
    inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 10, marginBottom: 15, borderColor: '#e0e0e0', borderWidth: 1 },
    ...
    linkText: { color: '#3a86f4', fontSize: 16, fontWeight: 'bold', marginLeft: 5 },
    modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.6)' },
    loaderBox: { backgroundColor: '#2c3e50', borderRadius: 15, padding: 25, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' },
    loadingText: { color: '#FFFFFF', marginLeft: 15, fontSize: 16, fontWeight: '500' },
});
