export const CATEGORIES = [
  // { id: "ACIDENTE", name: "Acidente", icon: "car-crash" },
  // { id: "INTERFERENCIA_VIA", name: "Interferência na via", icon: "road-variant" },
  // { id: "SEMAFORO", name: "Semáforo", icon: "traffic-light" },
  // { id: "OLEO_PISTA", name: "Óleo na pista", icon: "oil" },
  // { id: "VEICULO_QUEBRADO", name: "Veículo quebrado", icon: "car-wrench" },
